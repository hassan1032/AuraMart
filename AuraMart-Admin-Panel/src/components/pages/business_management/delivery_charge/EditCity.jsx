...
const EditCity = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Edit City" subtitle="Update city details" breadcrumbs={[{ label: "Business" }, { label: "Cities" }, { label: "Edit" }]} />
        ...
        <Card>
          ...
          <CardBody>
            ...
            <div className="flex justify-between mt-6 pt-4 border-t border-gray-100">
              ...
              <Button type="submit" icon={<Save size={14} />}>Update City</Button>
            </div>
          </CardBody>
        </Card>
      </form>
