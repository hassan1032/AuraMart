...
const EditDeliveryCharge = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Edit Delivery Charge" subtitle="Update delivery pricing for a city" breadcrumbs={[{ label: "Business" }, { label: "Delivery" }, { label: "Edit" }]} />
        ...
        <Card>
          ...
          <CardBody>
            ...
            <div className="flex justify-between mt-6 pt-4 border-t border-gray-100">
              ...
              <Button type="submit" icon={<Save size={14} />}>Update Charge</Button>
            </div>
          </CardBody>
        </Card>
      </form>
