...
const EditTermAndCondition = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Edit Terms & Conditions" subtitle="Update your terms and conditions content"
        breadcrumbs={[{ label: "Legal" }, { label: "Terms", href: "/admin/business/term-and-condition" }, { label: "Edit" }]}
        action={<Link to="/admin/business/term-and-condition"><Button variant="secondary" icon={<ArrowLeft size={14} />}>Back</Button></Link>}
      />
          ...
          <CardBody>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea value={content} onChange={e => setContent(e.target.value)} rows={16} placeholder="Enter terms and conditions content..."
